...
$objPHPExcel = $objReader->load("./Examples/templates/Passport.xls");
	...
	//Антивирус Версия B30
		$objPHPExcel->getActiveSheet()->setCellValue('B30',$_POST['AntivirusV']);
 	//Фактура номер C30
	...
	$objPHPExcel->getActiveSheet()->setCellValue('B33',$_POST['ImosV']);
			...
			//D33 Лиценз
			$objPHPExcel->getActiveSheet()->setCellValue('D33',$_POST['ImosL']);
	...
	$objPHPExcel->getActiveSheet()->setCellValue('B34',$_POST['AccessV']);
		...
		//D34 Лиценз
		$objPHPExcel->getActiveSheet()->setCellValue('D34',$_POST['AccessL']);
...
$objWriter->save("./IRIM_Passport/".$_POST['PC_Conf']."_Passport_PC_IRIM".'.xls');
